...
const CareerPage: React.FC<CareerPageProps> = () => {
  const infoCards = [
    ...
    {
      imageSrc:
        'https://cdn.builder.io/api/v1/image/assets/TEMP/27745129630096b0ecca6a83eabdfc869daacffe28d1a042b43e0ab23eceb00b?placeholderIfAbsent=true&apiKey=f547751f91f54b6a805677abc411ee2e',
      title: 'Diversity & Inclusion',
      description:
        'We encourage an environment where our employess feel safe, grow and make impact.',
    },
    {
      imageSrc:
        'https://cdn.builder.io/api/v1/image/assets/TEMP/4dc1c9627ee3426508bb8edf1dee929759739ded24cc0af912feebd633997500?placeholderIfAbsent=true&apiKey=f547751f91f54b6a805677abc411ee2e',
      title: 'Economic and Environmental Impact',
      description:
        'Promoting an eco-conscious environment, we advocate for sustainability amount our users both sells and buyers.',
    },
  ];
