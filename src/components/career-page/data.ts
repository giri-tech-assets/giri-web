...
export const backendEngineerJob: JobListing = {
  id: 1,
  title: "Backend Engineer - Help African Businesses Reach Global Markets",
  company: "GirTodayi",
  location: "Remote",
  type: "Full-time",
...
export const productManagerJob: JobListing = {
  ...
  description: "GiriToday is a global marketplace for unique and creative goods. We build, power, and evolve the tools and technologies that connect millions of African sellers with millions of buyers around the world. The Product Management team is responsible for defining the strategy and priorities to ensure GiriToday is a safe marketplace that buyers and sellers trust. We focus on detecting policy violative content and adversarial actors, and on crafting educational and reformative experiences for members to prevent harm from happening.",
  responsibilities: [
    "Provide leadership and help set the direction for GiriToday's suite of policy violating detection systems",
    ...
    "Have empathy for our end users and care about their safety on GiriToday"
  ],
  requirements: [
...
export const frontendEngineerJob: JobListing  = {
  id: 1,
  title: "Frontend Engineer - Help African Businesses Reach Global Markets",
  company: "Giri",
  location: "Remote",
  type: "Full-time",
  department: "Engineering",
  description: "Giri is revolutionizing how African small and medium-scale businesses reach global audiences. Our e-commerce platform enables skilled craftspeople to share their unique creations with customers worldwide, fostering economic growth and cultural exchange.",
  responsibilities: [
...
export const productDesignerJob: JobListing  = {
  ...
  description: "GiriToday is a global marketplace for unique and creative goods. We build, power, and evolve the tools and technologies that connect millions of African sellers with millions of buyers around the world. Design & UX sits within GiriToday's Core Product Design organization as a comprehensive, cross-functional design team excelling in taste-making, strategy, design systems, visual design, experience design, content creation, and motion design.",
  responsibilities: [
    "Develop and refine GiriToday's design system by integrating visual design, interaction design, and systems thinking",
