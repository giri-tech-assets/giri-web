...
const careersHeaderConfig = {
  styles: {
    header: `flex flex-col justify-center self-center max-w-full text-base w-full mb-12 mt-10`,
    container: `flex flex-col justify-center items-center w-full`,
    title: `text-5xl font-bold leading-tight text-center text-gray-900 mb-4 max-md:text-4xl`,
    subtitle: `text-xl text-center text-gray-600 max-w-2xl mx-auto`,
  },
  content: {
    title: `Join Our Mission to Empower Africa`,
    subtitle: `Be part of the fastest-growing marketplace connecting Africa to the world.`,
  },
};
