...
const images = {
  facebook:
    'https://cdn.builder.io/api/v1/image/assets/TEMP/3f6e158ea63428bf9b136c6543bc1a4da1a308ed94fbd4b5421bbf3a56d3c0e5?placeholderIfAbsent=true&apiKey=f547751f91f54b6a805677abc411ee2e',
  twitter:
    'https://cdn.builder.io/api/v1/image/assets/TEMP/4ac983acb498f00c104e7d52ed248f64ea7336cf6f6e63c2f4382a09f8fbe18d?placeholderIfAbsent=true&apiKey=f547751f91f54b6a805677abc411ee2e',
};
...
const footerConfig = {
  ...
  styles: {
    footer:
      'flex flex-col justify-center px-20 py-5 w-full bg-slate-800 max-md:px-5 max-md:max-w-full',
    contentWrapper:
      'flex flex-wrap gap-10 items-center max-md:mr-0.5 max-md:max-w-full',
    ...
    divider:
      'flex shrink-0 mt-7 h-px bg-stone-300 bg-opacity-50 max-md:max-w-full',
    bottomContent:
      'flex flex-wrap gap-10 items-start mt-6 text-sm text-white max-md:max-w-full',
        ...
        {footerConfig.socialLinks.map((link) => (
          <a key={link.href} href={link.href} aria-label={link.ariaLabel}>
            <img
              ...
              src={link.imgSrc}
              alt=""
              className={footerConfig.styles.socialIcon}
            />
          </a>
        ))}
      </div>
    ...
    <div className={footerConfig.styles.bottomContent}>
      ...
      <div className={footerConfig.styles.legalLinks}>
        {footerConfig.legalLinks.map((link) => (
          <a key={link.href} href={link.href} className="self-stretch my-auto">
            {link.text}
          </a>
        ))}
      </div>
